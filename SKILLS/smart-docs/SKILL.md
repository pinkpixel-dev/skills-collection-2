...
description: Codebase documentation generator. Analyzes project structure, identifies architectural patterns, and generates professional technical documentation. 
allowed-tools:
  - "Read"
  - "Glob"
  - "Write"
...
[Build and deploy instructions for development and production]
